---
title: 动手实现一个简单的RPC框架（一）：原理和程序的结构
date: 2022-03-09 22:12:34
permalink: /pages/12dc06/
categories:
  - 极客时间
  - 消息队列高手课
tags:
  - 
---
<audio title="31.动手实现一个简单的RPC框架（一）：原理和程序的结构" src="https://static001.geekbang.org/resource/audio/e2/79/e236850409129aed8756da485c62db79.mp3" controls="controls"></audio> 
