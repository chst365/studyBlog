...
date: 2022-03-09 19:19:16
permalink: /pages/abfdee/
categories:
  - 极客时间
  - 手把手带你写一门编程语言
tags:
...
<p>你好，我是宫文学。</p><p>不知道你还记不记得，我们在<a href="https://time.geekbang.org/column/article/406179">第一节课</a>就支持了函数功能。不过那个版本的函数功能是被高度简化了的，比如，它不支持声明函数的参数，也不支持函数的返回值。</p><p>在上一节课实现了对变量的支持以后，我们终于可以进一步升级我们的函数功能了。为什么要等到这个时候呢？因为其实函数的参数的实现机制跟变量是很类似的。</p><p>为了升级我们的函数功能，我们需要完成几项任务：</p><ol>
