---
title: Host容器：Tomcat如何实现热部署和热加载？
date: 2022-03-09 14:34:16
permalink: /pages/620545/
categories:
  - 极客时间
  - 深入拆解Tomcat&Jetty
tags:
  - 
---
<audio title="23.Host容器：Tomcat如何实现热部署和热加载？" src="https://static001.geekbang.org/resource/audio/a7/73/a7049437f86d62aeb23a8c93d15f4473.mp3" controls="controls"></audio> 
<p>从这一期我们开始学习Tomcat的容器模块，来聊一聊各容器组件实现的功能，主要有热部署热加载、类加载机制以及Servlet规范的实现。最后还会谈到Spring Boot是如何与Web容器进行交互的。</p><p>今天我们首先来看热部署和热加载。要在运行的过程中升级Web应用，如果你不想重启系统，实现的方式有两种：热加载和热部署。</p><p>那如何实现热部署和热加载呢？它们跟类加载机制有关，具体来说就是：</p><ul>
