---
title: 性能场景的数据到底应该做成什么样子？
date: 2022-03-09 16:57:09
permalink: /pages/ee4456/
categories:
  - 极客时间
  - 高楼的性能工程实战课
tags:
  - 
---
<audio title="07.性能场景的数据到底应该做成什么样子？" src="https://static001.geekbang.org/resource/audio/ec/a1/ec8bf8yy7f94897d221ab090161977a1.mp3" controls="controls"></audio> 
<p>你好，我是高楼。</p><p>在性能项目中，性能数据是非常重要的输入资源。但是我经常看到有人拿着少得可怜的数据，来做比较大的压力，这显然不符合真实的场景，虽然拿到的结果很好看，但并不会得到什么有价值的结果。所以，今天我们就来讲一下性能场景中的数据到底应该做成什么样子。</p><p>在RESAR性能工程中，场景里使用的数据需要满足两个方面：</p><ul>
