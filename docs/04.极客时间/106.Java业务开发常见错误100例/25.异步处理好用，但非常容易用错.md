---
title: 异步处理好用，但非常容易用错
date: 2022-03-09 13:11:15
permalink: /pages/5859ea/
categories:
  - 极客时间
  - Java业务开发常见错误100例
tags:
  - 
---
<audio title="25.异步处理好用，但非常容易用错" src="https://static001.geekbang.org/resource/audio/01/24/0141dac641c535a30a2bdafadcca2924.mp3" controls="controls"></audio> 
<p>你好，我是朱晔。今天，我来和你聊聊好用但容易出错的异步处理。</p><p>异步处理是互联网应用不可或缺的一种架构模式，大多数业务项目都是由同步处理、异步处理和定时任务处理三种模式相辅相成实现的。</p><p>区别于同步处理，异步处理无需同步等待流程处理完毕，因此适用场景主要包括：</p><ul>
