---
title: 测试数据：是不是可以把所有的参数都保存到Excel中？
date: 2022-03-09 15:12:31
permalink: /pages/1af4df/
categories:
  - 极客时间
  - 接口测试入门课
tags:
  - 
---
<audio title="08.测试数据：是不是可以把所有的参数都保存到Excel中？" src="https://static001.geekbang.org/resource/audio/2d/6e/2d4d9ee7fcc0e9509dc78cfc3c78926e.mp3" controls="controls"></audio> 
