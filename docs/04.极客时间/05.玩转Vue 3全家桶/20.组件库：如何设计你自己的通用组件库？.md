...
date: 2022-03-08 21:58:44
permalink: /pages/e9ec95/
categories:
  - 极客时间
  - 玩转Vue 3全家桶
tags:
...
</code></pre><p>这样就确保在GitHub中的提交日志都符合type(scope): message 的格式。你可以看下Vue 3的<a href="https://github.com/vuejs/vue-next/commits/master">代码提交记录</a>，每个提交涉及的模块，类型和信息都清晰可见，能够很好地帮助我们管理版本日志，校验正则的逻辑。如下图，feat代表新功能，docs代表文档，perf代表性能。下面的提交日志就能告诉我们这次提交的是组件相关的新功能，代码中新增了Button.vue。</p><pre><code class="language-typescript">feat(component): add Button.vue
